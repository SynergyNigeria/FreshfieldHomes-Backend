...
from .views import (
    ...
    agent_portal_my_listings,
    agent_portal_properties,
    agent_portal_submit_listing,
    admin_decide_listing,
...
urlpatterns = [
    ...
    path("agent-portal/submit-listing/", agent_portal_submit_listing, name="agent-portal-submit-listing"),
    path("agent-portal/my-listings/", agent_portal_my_listings, name="agent-portal-my-listings"),
    ...
    path("admin/listings/pending/", admin_pending_listings, name="admin-pending-listings"),
    path("admin/listings/<str:public_id>/decide/", admin_decide_listing, name="admin-decide-listing"),
]
